        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-700">
              ...
              <th className="px-6 py-3 text-left text-sm font-semibold text-slate-600 dark:text-slate-300">Products</th>
          ...
          <tbody>
            {filtered.map((category, i) => (
              <tr key={category.id} className="border-b border-slate-100 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                <td className="px-6 py-4 text-sm font-semibold text-slate-800 dark:text-white">{category.name}</td>
                <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">{category.description || "—"}</td>
                <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">{category.productCount}</td>
